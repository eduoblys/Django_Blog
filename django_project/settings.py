...
SECRET_KEY = '0+*j^95x1px@kwc@r(_se8$cc@(!vg1e&gm%)@^=)__o9h_5k2'
...
TIME_ZONE = 'UTC'
#Europe/Copenhagen     TIME_ZONE = 'UTC'
USE_I18N = True
...
DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'        #django-storages Amazon S3 docs
